...
// import { createUser, getAll, getByEmail, getUser } from '../controllers/sessionDAO.js';
...
//   req.session.user = req.user.email; // Asignar el correo electrónico del usuario
...
//   //   res.redirect('/products?role=admin');
//   // } else {
//   //   // Redirigir como usuario normal
//   //   res.redirect('/products?role=user');
//   // }
// });
